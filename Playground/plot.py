...
# Data for METR-LA Dataset
metr_la_data = {
    'Model': ['A3T-GCN', 'DCRNN', 'Enc-G-Dec'],
    'RMSE': [3.8989, 5.38, 0.7379],
    'MAE': [2.6480, 2.77, 0.4763],
    'MAPE': [168.376, 122.95,166.77],
}

# Data for PeMS-D7 Dataset
pems_d7_data = {
    'Model': ['ASTGCN', 'SSTGCN', 'ST-GCN', 'Enc-G-Dec'],
    'RMSE': [25.27, 59.7008, 6.90,  0.7291],
    'MAE': [16.63, 58.1919, 4.21, 0.4935],
    'MAPE': [192.87, 98.446, 160.32, 230.28],
}

# Data for ChickenPox Dataset
chickenpox_data = {
    'Model': ['A3T-GCN', 'DCRNN', 'EvolveGCN-H', 'EvolveGCN-O', 'MPNN-LSTM', 'AGCRN', 'Enc-G-Dec'],
    'RMSE': [0.9752, 0.9672, 0.9786, 0.9777, 1.0679, 1.0209, 0.7588],
    'MAE': [0.6303, 0.6183, 0.6373, 0.6299, 0.7670, 0.6881, 0.5295],
    'MAPE': [542.53, 538.73, 944.008, 684.62, 2138.42, 822.22, 242.20],
}
